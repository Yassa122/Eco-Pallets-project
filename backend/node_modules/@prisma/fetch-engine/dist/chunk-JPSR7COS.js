...
var chunk_JPSR7COS_exports = {};
__export(chunk_JPSR7COS_exports, {
  cleanupCache: () => cleanupCache
});
module.exports = __toCommonJS(chunk_JPSR7COS_exports);
...
async function cleanupCache(n = 5) {
  try {
    const rootCacheDir = await (0, import_chunk_VCPEVVH2.getRootCacheDir)();
    if (!rootCacheDir) {
