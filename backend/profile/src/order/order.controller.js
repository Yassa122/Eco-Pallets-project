...
var OrderController = function () {
    ...
    var OrderController = _classThis = /** @class */ (function () {
        ...
        OrderController_1.prototype.getAllOrders = function (userId) {
            return __awaiter(this, void 0, void 0, function () {
                var orders;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, this.orderService.findAllOrders(userId)];
                        case 1:
                            orders = _a.sent();
    ...
    (function () {
        ...
        _getAllOrders_decorators = [(0, common_1.Get)(':userId')];
