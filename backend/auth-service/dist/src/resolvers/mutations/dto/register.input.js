...
const user_rol_enum_1 = require("./user-rol.enum");
...
__decorate([
    (0, graphql_1.Field)(() => user_rol_enum_1.UserRole, { defaultValue: user_rol_enum_1.UserRole.USER }),
    __metadata("design:type", String)
...
__decorate([
    (0, graphql_1.Field)({ nullable: true }),
    __metadata("design:type", String)
], RegisterInput.prototype, "company", void 0);
__decorate([
    (0, graphql_1.Field)({ nullable: true }),
    __metadata("design:type", String)
