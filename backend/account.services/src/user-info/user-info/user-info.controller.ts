...
constructor(private UserInfoService: UserInfoService) {}
  ...
  @Post('add-address/:userId')
    addShippingAddress(@Param('userId') userId: string, @Body() addressDto: AddShippingAddressDto) {
        return this.UserInfoService.addShippingAddress(userId, addressDto);
    }

    @Put('update-address/:userId')
    updateShippingAddress(@Param('userId') userId: string, @Body() updateDto: UpdateShippingAddressDto) {
        return this.UserInfoService.updateShippingAddress(userId, updateDto);
    }

    @Delete('delete-address/:userId')
    deleteShippingAddress(@Param('userId') userId: string, @Body() deleteDto: DeleteShippingAddressDto) {
