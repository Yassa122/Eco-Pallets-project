...
const HomeFeatures = () => {
  return (
    <section className="flex flex-col items-center justify-center p-6 sm:p-10 md:p-20">
      <div className="text-white text-center mb-8 sm:mb-10">
        <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold">FEATURES</h2>
      </div>
      <div className="w-full max-w-full rounded-xl bg-custom-gradient p-6 sm:p-10 md:p-32">
