...
export function Navbar({ title }: NavbarProps) {
  ...
  return (
    <>
          ...
          <div className="flex items-center justify-center flex-grow">
            ...
            <div className="relative flex items-center space-x-2">
              ...
              <input
                ...
                className={`px-4 py-2 rounded-md outline-none bg-transparent text-base text-white placeholder-gray-400 border ${isSearchFocused ? 'border-green-500' : 'border-gray-300'}`}
              />
            </div>
            {/* End of Search Bar */}
          </div>
      ...
      {searchResults && <SearchResultsPopup results={searchResults} onClose={closePopup} />}
    </>
  );
}
