...
const ShoppingCart = () => {
  ...
  const calculateTotal = () => {
    const subbtotal = cartItems.reduce(
    ...
    <div>
      ...
      >
        {cartItems.map((item, index) => {
          const ProductImage = require(`../../images/cart/${item.productName
            .replace(/\s/g, "")
          ...
          return (
            <div
              ...
              style={{
                ...
                alignItems: "center",
                borderBottom:
                  index !== cartItems.length - 1 ? "1px solid white" : "none",
                padding: "3vh",
              }}
            >
              <Image
              ...
              <div>
                ...
                >
                  ...
                  <span style={{ margin: "0 10px", fontSize: "0.8rem" }}>
                    {item.quantity}
                  </span>
